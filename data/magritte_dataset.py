...
from data.image_folder import make_dataset, make_magritte_dataset
from PIL import Image


class MagritteDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        self.ABC_paths = make_magritte_dataset(self.dir_AB, opt.max_dataset_size)  # get image paths
    ...
    def __getitem__(self, index):
        ...
        if os.path.exists(ABC_path['C']): 
            ...
            C = Image.new('RGB', B.size, (255, 255, 255))
